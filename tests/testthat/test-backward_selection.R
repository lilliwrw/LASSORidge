...
test_that("backward selection input validation", {
  ...
  expect_error(backward_stepwise_selection(data, letters[1:3], "output", weights = NULL, nparam = c(1,1,1,1), unlist_return_value = FALSE, interactions = FALSE, intercept = TRUE, return_lm = FALSE), regexp = "duplicate subset size present in 'nparam', dropping duplicates")
